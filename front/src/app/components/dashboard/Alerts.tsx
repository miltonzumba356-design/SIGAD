  ...
  const alerts = [
    {
      ...
      message: `${stats?.atrasados || 0} documentos com devolução em atraso`,
      className: 'bg-destructive/10 border-destructive/20 text-destructive'
    },
    {
      id: 'digitization',
      icon: Info,
      title: 'Fila de digitalização',
      message: `${stats?.pendentes_dig || 0} documentos aguardando digitalização`,
