...
export const validarCriacaoDocumento = [
  body('instituicao_id')
    .isInt({ min: 1 })
    .withMessage('instituicao_id deve ser um número inteiro positivo'),

  body('pasta_id')
    .isInt({ min: 1 })
    .withMessage('pasta_id deve ser um número inteiro positivo'),

  body('codigo_referencia')
    .trim()
    .notEmpty()
    .withMessage('codigo_referencia é obrigatório')
    .isLength({ max: 100 })
    .withMessage('codigo_referencia deve ter no máximo 100 caracteres'),
  ...
  body('nivel_confidencialidade_id')
    .isInt({ min: 1 })
    .withMessage('nivel_confidencialidade_id deve ser um número inteiro positivo'),

  body('created_by')
    .isInt({ min: 1 })
    .withMessage('created_by deve ser um número inteiro positivo'),
...
export const validarCriacaoEmprestimo = [
  body('documento_id')
    .isInt({ min: 1 })
    .withMessage('documento_id deve ser um número inteiro positivo'),
